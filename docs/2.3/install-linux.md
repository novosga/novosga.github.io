...
Criar o projeto:
    ...
    php composer.phar create-project "novosga/novosga:^2.3" ~/novosga
...
**Debian/Ubuntu**
    ...
    sudo echo 'date.timezone = America/Sao_Paulo' > /etc/php/8.2/apache2/conf.d/datetimezone.ini
...
!> Formato da URL de conexão com o banco de dados: http://docs.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/configuration.html#connecting-using-a-url
    ...
    SetEnv DATABASE_URL mysql://novosga:MySQL_App_P4ssW0rd@mysqldb:3306/novosga2?charset=utf8mb4&serverVersion=8.0
